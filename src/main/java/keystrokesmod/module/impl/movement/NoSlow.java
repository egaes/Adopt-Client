...
public class NoSlow extends Module {
    ...
    public static ButtonSetting swordDisabled;
    private String[] modes = new String[]{"Vanilla", "Pre", "Post", "Alpha", "Hypixel"};
    ...
    public NoSlow() {
        ...
        this.registerSetting(swordDisabled = new ButtonSetting("Disable sword", false));
    }
    ...
    public void onUpdate() {
        ...
        postPlace = false;
        if (swordDisabled.isToggled() && Utils.holdingSword()) {
            return;
        }
    ...
    public static float getSlowed() {
        if (mc.thePlayer.getHeldItem() == null || ModuleManager.noSlow == null || !ModuleManager.noSlow.isEnabled()) {
            ...
            if (swordDisabled.isToggled() && (mc.thePlayer.getHeldItem().getItem() instanceof ItemSword)) {
                return 0.2f;
            }
    ...
    private boolean holdingConsumable(ItemStack itemStack) {
        ...
        if (heldItem instanceof ItemFood || heldItem instanceof ItemBow || (heldItem instanceof ItemPotion && !ItemPotion.isSplash(mc.thePlayer.getHeldItem().getItemDamage())) || (heldItem instanceof ItemSword && !swordDisabled.isToggled())) {
            return true;
        }
        return false;
    }
